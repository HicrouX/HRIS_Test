...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 04, 2026 at 08:59 AM
...
(1, 1, NULL, 'John', NULL, 'Super', NULL, NULL, NULL, 'super@hris.com', NULL, 'System Owner', NULL, NULL, NULL, NULL, 'Permanent', '2023-01-01', 0),
(2, 2, NULL, 'Jane', NULL, 'Admin', NULL, NULL, NULL, 'admin@hris.com', NULL, 'HR Manager', NULL, NULL, NULL, NULL, 'Permanent', '2023-02-15', 0),
(3, 3, NULL, 'Robert', NULL, 'Coach', NULL, NULL, NULL, 'coach1@hris.com', NULL, 'Team Lead', NULL, 1, NULL, NULL, 'Permanent', '2023-03-10', 0),
(4, 4, NULL, 'Sarah', NULL, 'Manager', NULL, NULL, NULL, 'coach2@hris.com', NULL, 'Operations Manager', NULL, 2, NULL, NULL, 'Permanent', '2023-04-05', 0),
(5, 5, NULL, 'Alice', NULL, 'Smith', NULL, NULL, NULL, 'emp1@hris.com', NULL, 'Developer', NULL, 1, NULL, NULL, 'Regular', '2024-01-10', 0),
(6, 6, NULL, 'Bob', NULL, 'Jones', NULL, NULL, NULL, 'emp2@hris.com', NULL, 'Designer', NULL, 2, NULL, NULL, 'Regular', '2024-01-12', 0),
(7, 7, NULL, 'Charlie', NULL, 'Brown', NULL, NULL, NULL, 'emp3@hris.com', NULL, 'Support', NULL, 2, NULL, NULL, 'Probationary', '2024-02-01', 0),
(8, 8, NULL, 'David', NULL, 'Wilson', NULL, NULL, NULL, 'emp4@hris.com', NULL, 'Developer', NULL, 1, NULL, NULL, 'Regular', '2024-02-15', 0),
(9, 9, NULL, 'Eve', NULL, 'Davis', NULL, NULL, NULL, 'emp5@hris.com', NULL, 'QA Engineer', NULL, 1, NULL, NULL, 'Regular', '2024-03-01', 0);
...
ALTER TABLE `attendance_disputes`
  ...
  ADD KEY `attendance_disputes_ibfk_1` (`cluster_id`),
  ADD KEY `attendance_disputes_ibfk_2` (`employee_id`);
...
ALTER TABLE `attendance_logs`
  ...
  ADD KEY `attendance_logs_ibfk_1` (`cluster_id`);
...
ALTER TABLE `break_logs`
  ...
  ADD KEY `break_logs_ibfk_1` (`time_log_id`),
  ADD KEY `break_logs_ibfk_2` (`cluster_id`);
...
ALTER TABLE `clusters`
  ...
  ADD KEY `clusters_ibfk_1` (`user_id`);
...
ALTER TABLE `cluster_members`
  ...
  ADD KEY `cluster_members_ibfk_2` (`employee_id`);
...
ALTER TABLE `employees`
  ...
  ADD KEY `employees_ibfk_2` (`permission_id`);
...
ALTER TABLE `leave_requests`
  ...
  ADD KEY `leave_requests_ibfk_3` (`approved_by`);
...
ALTER TABLE `overtime_requests`
  ...
  ADD KEY `overtime_requests_ibfk_1` (`employee_id`),
  ADD KEY `overtime_requests_ibfk_2` (`approved_by`);
...
ALTER TABLE `schedules`
  ...
  ADD KEY `schedules_ibfk_1` (`cluster_id`),
  ADD KEY `schedules_ibfk_2` (`employee_id`);
...
ALTER TABLE `time_logs`
  ...
  ADD KEY `time_logs_ibfk_1` (`user_id`),
  ADD KEY `time_logs_ibfk_2` (`employee_id`);
